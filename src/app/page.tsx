...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-4 bg-gray-100 min-h-screen dark:bg-dark">
      <Navbar />
      <main className="px-3 max-w-7xl mx-auto flex flex-col gap-9 dark:bg-dark w-full  pb-10 pt-4 ">
        {/* today data  */}
        {loadingCity ? (
          <WeatherSkeleton />
        ) : (
          <>
            <section className="space-y-4 ">
              <div className="space-y-2">
                ...
                <Container className=" gap-10 px-6 items-center dark:bg-dark">
                  {/* temprature */}
              ...
              <div className=" flex gap-4">
                {/* left  */}
                <Container className="w-fit  justify-center flex-col px-4 items-center dark:bg-dark ">
            ...
            <section className="flex w-full flex-col gap-4  ">
              <div className="text-2xl">Forcast (7 days)</div>
